    ...
    <div className="px-4 pb-8 xl:px-6">
      ...
      <div className="pt-5">
        <Header
          ...
          buttonComponent={
            <button
              className="flex items-center gap-1 rounded bg-blue-primary px-3 py-2 text-sm font-medium text-white shadow hover:bg-blue-600 focus:outline-none focus:ring-2 focus:ring-blue-400"
