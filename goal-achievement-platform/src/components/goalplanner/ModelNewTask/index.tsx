...
const ModelNewTask = ({ isOpen, onClose, id = null }: Props) => {
  // ⛔️ Removed backend mutation hook
  // const [createTask, { isLoading }] = useCreateTaskMutation();
  const isLoading = false; // ✅ Frontend-only mode placeholder
  ...
  const handleSubmit = async () => {
    ...
    // ⛔️ Commented backend task creation logic
    // await createTask({
    //   title,
    //   description,
    //   status,
